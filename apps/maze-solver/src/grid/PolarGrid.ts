import { forEach } from '@apestaartje/iterator/forEach/forEach';
...
export class PolarGrid extends Grid<PolarCell> {
  ...
  public getCell(position: GridPosition): PolarCell | undefined {
  ...
  protected positionToKey(position: GridPosition): string {
