...
/**
 * Distances class represents the distances from a root cell to other cells in a maze.
 * It uses a Map to store the distances, where the key is a Cell and the value is the distance from the root cell.
 */
